...
There are different realizations of hyperbolic space. I find it convenient to use the the hyperboloid model of hyperbolic space (see for instance [3]) as it is connected to Minkowski space and I can rely on some intuition from the theory of special relativity in 4 space-time dimensions. 
